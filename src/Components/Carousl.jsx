...
function Carousl() {
  ...
  return (
    <div className="carousl">
      ...
      <h2 className= "slide-in" ref={el => elementsRef.current[0] = el}>
        <svg
          width="49"
          height="48"
          viewBox="0 0 49 48"
